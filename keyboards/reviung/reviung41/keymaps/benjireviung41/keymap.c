...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  * |------+------+------+------+------+------+         +------+------+------+------+------+------|
  * |      |      |   ç  |   Å  |   Ä  |   Ö  |         | Home |  End | PgUp | PgDn |   ~  | Enter|
  * |------+------+------+------+------+------+         +------+------+------+------+------+------|
  *                             |      |      |  Space  |      |      |
  *                             +-------------/         \-------------+
  */
  [_LOWER] = LAYOUT_reviung41(
    ...
    _______,  KC_MINS,  KC_EQL,   KC_LBRC,  KC_RBRC,   KC_PIPE,            KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_GRV,   KC_BSPC,
    _______,  FR_CCED,  SE_ARNG,  SE_ADIA,  SE_ODIA,   _______,            KC_HOME,  KC_END,   KC_PGUP,  KC_PGDN,  KC_TILD,  KC_ENT,
